...
from agents.run.configs import PPO_CONFIG
...
Example Usage via executable:
    ~/PycharmProjects/mt-join-queryoptimization-with-drl/agents/customray/dqn/custom_rollout_ppo.py 3/PPO_CM1-postgres-card-job-masking-v0_0_2019-06-21_00-08-26s4m442pg/checkpoint_50/checkpoint-50 --run PPO --env CM1-postgres-card-job-masking-v0 --no-render >> rollout/3_PPO_CM1-postgres-card-job-masking-v0_0_2019-06-21_00-08.txt
...
#register_env("CM1-postgres-card-job-masking-v0", lambda _: ActionMasking())
